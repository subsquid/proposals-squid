...
export type Type_361 = Type_361_System | Type_361_Indices | Type_361_Balances | Type_361_Staking | Type_361_Offences | Type_361_Session | Type_361_Grandpa | Type_361_ImOnline | Type_361_Democracy | Type_361_Council | Type_361_TechnicalCommittee | Type_361_ElectionsPhragmen | Type_361_TechnicalMembership | Type_361_Treasury | Type_361_Claims | Type_361_Slots | Type_361_Registrar | Type_361_Utility | Type_361_Identity | Type_361_Society | Type_361_Recovery | Type_361_Vesting | Type_361_Scheduler | Type_361_Proxy | Type_361_Multisig

export interface Type_361_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_361_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_361_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_361_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_361_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_361_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_361_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_361_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_361_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_361_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_361_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_361_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenEvent
}

export interface Type_361_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_361_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_361_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_361_Slots {
  __kind: 'Slots'
  value: SlotsEvent
}

export interface Type_361_Registrar {
  __kind: 'Registrar'
  value: RegistrarEvent
}

export interface Type_361_Utility {
  __kind: 'Utility'
  value: UtilityEvent
}

export interface Type_361_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}

export interface Type_361_Society {
  __kind: 'Society'
  value: SocietyEvent
}

export interface Type_361_Recovery {
  __kind: 'Recovery'
  value: RecoveryEvent
}

export interface Type_361_Vesting {
  __kind: 'Vesting'
  value: VestingEvent
}

export interface Type_361_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerEvent
}

export interface Type_361_Proxy {
  __kind: 'Proxy'
  value: ProxyEvent
}

export interface Type_361_Multisig {
  __kind: 'Multisig'
  value: MultisigEvent
}
