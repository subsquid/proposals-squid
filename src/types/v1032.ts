...
export type Type_253 = Type_253_System | Type_253_Indices | Type_253_Balances | Type_253_Staking | Type_253_Offences | Type_253_Session | Type_253_Grandpa | Type_253_ImOnline | Type_253_Democracy | Type_253_Council | Type_253_TechnicalCommittee | Type_253_ElectionsPhragmen | Type_253_TechnicalMembership | Type_253_Treasury | Type_253_Claims | Type_253_Slots | Type_253_Registrar | Type_253_Nicks | Type_253_Identity | Type_253_Utility

export interface Type_253_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_253_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_253_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_253_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_253_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_253_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_253_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_253_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_253_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_253_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_253_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_253_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenEvent
}

export interface Type_253_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_253_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_253_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_253_Slots {
  __kind: 'Slots'
  value: SlotsEvent
}

export interface Type_253_Registrar {
  __kind: 'Registrar'
  value: RegistrarEvent
}

export interface Type_253_Nicks {
  __kind: 'Nicks'
  value: NicksEvent
}

export interface Type_253_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}

export interface Type_253_Utility {
  __kind: 'Utility'
  value: UtilityEvent
}
...
export interface Type_98_Nicks {
  __kind: 'Nicks'
  value: NicksCall
}
