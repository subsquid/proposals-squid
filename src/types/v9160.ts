...
export type Phase_147 = Phase_147_ApplyExtrinsic | Phase_147_Finalization | Phase_147_Initialization

export interface Phase_147_ApplyExtrinsic {
  __kind: 'ApplyExtrinsic'
  value: number
}

export interface Phase_147_Finalization {
  __kind: 'Finalization'
}

export interface Phase_147_Initialization {
...
export interface XcmPalletEvent_Sent {
  __kind: 'Sent'
  value: [V1MultiLocation, V1MultiLocation, V2Instruction_123[]]
}
