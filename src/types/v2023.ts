...
export interface CdpEngineCall_set_collateral_params {
  ...
  currencyId: CurrencyId
  interestRatePerSec: Change_286
  liquidationRatio: Change_286
  liquidationPenalty: Change_286
  requiredCollateralRatio: Change_286
  maximumTotalDebitValue: Change_287
}
...
export type Change_286 = Change_286_NoChange | Change_286_NewValue

export interface Change_286_NoChange {
  __kind: 'NoChange'
}

export interface Change_286_NewValue {
  __kind: 'NewValue'
  value: (FixedU128 | undefined)
}

export type Change_287 = Change_287_NoChange | Change_287_NewValue

export interface Change_287_NoChange {
  __kind: 'NoChange'
}

export interface Change_287_NewValue {
  __kind: 'NewValue'
  value: bigint
}
...
export type RawOrigin_107 = RawOrigin_107_Root | RawOrigin_107_Signed | RawOrigin_107_None

export interface RawOrigin_107_Root {
  __kind: 'Root'
}

export interface RawOrigin_107_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_107_None {
  __kind: 'None'
}

export type Origin_108 = Origin_108_Xcm | Origin_108_Response

export interface Origin_108_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_108_Response {
  __kind: 'Response'
  value: V1MultiLocation
}

export type Origin_109 = Origin_109_Relay | Origin_109_SiblingParachain

export interface Origin_109_Relay {
  __kind: 'Relay'
}

export interface Origin_109_SiblingParachain {
...
export type RawOrigin_112 = RawOrigin_112_Members | RawOrigin_112_Member | RawOrigin_112__Phantom

export interface RawOrigin_112_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_112_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_112__Phantom {
  __kind: '_Phantom'
}
...
export type V2Instruction_253 = V2Instruction_253_WithdrawAsset | V2Instruction_253_ReserveAssetDeposited | V2Instruction_253_ReceiveTeleportedAsset | V2Instruction_253_QueryResponse | V2Instruction_253_TransferAsset | V2Instruction_253_TransferReserveAsset | V2Instruction_253_Transact | V2Instruction_253_HrmpNewChannelOpenRequest | V2Instruction_253_HrmpChannelAccepted | V2Instruction_253_HrmpChannelClosing | V2Instruction_253_ClearOrigin | V2Instruction_253_DescendOrigin | V2Instruction_253_ReportError | V2Instruction_253_DepositAsset | V2Instruction_253_DepositReserveAsset | V2Instruction_253_ExchangeAsset | V2Instruction_253_InitiateReserveWithdraw | V2Instruction_253_InitiateTeleport | V2Instruction_253_QueryHolding | V2Instruction_253_BuyExecution | V2Instruction_253_RefundSurplus | V2Instruction_253_SetErrorHandler | V2Instruction_253_SetAppendix | V2Instruction_253_ClearError | V2Instruction_253_ClaimAsset | V2Instruction_253_Trap | V2Instruction_253_SubscribeVersion | V2Instruction_253_UnsubscribeVersion

export interface V2Instruction_253_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_253_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_253_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_253_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_253_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_253_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_75[]
...
export interface V2Instruction_253_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_253_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_253_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_253_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_253_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_253_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_253_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_253_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_253_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_253_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_253_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_75[]
...
export interface V2Instruction_253_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_75[]
...
export interface V2Instruction_253_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_253_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_253_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_253_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_253[]
}

export interface V2Instruction_253_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_253[]
}

export interface V2Instruction_253_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_253_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_253_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_253_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_253_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
