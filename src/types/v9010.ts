...
export type Type_485 = Type_485_System | Type_485_Indices | Type_485_Balances | Type_485_Staking | Type_485_Offences | Type_485_Session | Type_485_Grandpa | Type_485_ImOnline | Type_485_Democracy | Type_485_Council | Type_485_TechnicalCommittee | Type_485_PhragmenElection | Type_485_TechnicalMembership | Type_485_Treasury | Type_485_Claims | Type_485_Utility | Type_485_Identity | Type_485_Society | Type_485_Recovery | Type_485_Vesting | Type_485_Scheduler | Type_485_Proxy | Type_485_Multisig | Type_485_Bounties | Type_485_Tips | Type_485_ElectionProviderMultiPhase | Type_485_Gilt | Type_485_ParasInclusion | Type_485_Paras | Type_485_ParasHrmp | Type_485_Registrar | Type_485_Slots | Type_485_Auctions | Type_485_Crowdloan | Type_485_XcmPallet

export interface Type_485_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_485_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_485_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_485_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_485_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_485_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_485_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_485_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_485_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_485_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_485_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_485_PhragmenElection {
  __kind: 'PhragmenElection'
  value: PhragmenElectionEvent
}

export interface Type_485_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_485_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_485_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_485_Utility {
  __kind: 'Utility'
  value: UtilityEvent
}

export interface Type_485_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}

export interface Type_485_Society {
  __kind: 'Society'
  value: SocietyEvent
}

export interface Type_485_Recovery {
  __kind: 'Recovery'
  value: RecoveryEvent
}

export interface Type_485_Vesting {
  __kind: 'Vesting'
  value: VestingEvent
}

export interface Type_485_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerEvent
}

export interface Type_485_Proxy {
  __kind: 'Proxy'
  value: ProxyEvent
}

export interface Type_485_Multisig {
  __kind: 'Multisig'
  value: MultisigEvent
}

export interface Type_485_Bounties {
  __kind: 'Bounties'
  value: BountiesEvent
}

export interface Type_485_Tips {
  __kind: 'Tips'
  value: TipsEvent
}

export interface Type_485_ElectionProviderMultiPhase {
  __kind: 'ElectionProviderMultiPhase'
  value: ElectionProviderMultiPhaseEvent
}

export interface Type_485_Gilt {
  __kind: 'Gilt'
  value: GiltEvent
}

export interface Type_485_ParasInclusion {
  __kind: 'ParasInclusion'
  value: ParasInclusionEvent
}

export interface Type_485_Paras {
  __kind: 'Paras'
  value: ParasEvent
}

export interface Type_485_ParasHrmp {
  __kind: 'ParasHrmp'
  value: ParasHrmpEvent
}

export interface Type_485_Registrar {
  __kind: 'Registrar'
  value: RegistrarEvent
}

export interface Type_485_Slots {
  __kind: 'Slots'
  value: SlotsEvent
}

export interface Type_485_Auctions {
  __kind: 'Auctions'
  value: AuctionsEvent
}

export interface Type_485_Crowdloan {
  __kind: 'Crowdloan'
  value: CrowdloanEvent
}

export interface Type_485_XcmPallet {
  __kind: 'XcmPallet'
...
export interface XcmPalletEvent_Sent {
  __kind: 'Sent'
  value: [MultiLocationV0, MultiLocationV0, XcmV0_390]
}
...
export interface XcmErrorV0_CannotReachDestination {
  ...
  value: [MultiLocationV0, XcmV0_390]
}
