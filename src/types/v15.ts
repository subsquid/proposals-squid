...
export type Proposal = Proposal_System | Proposal_Babe | Proposal_Timestamp | Proposal_Indices | Proposal_Balances | Proposal_Authorship | Proposal_Staking | Proposal_Session | Proposal_Grandpa | Proposal_ImOnline | Proposal_AuthorityDiscovery | Proposal_Offences | Proposal_Treasury | Proposal_Tips | Proposal_Council | Proposal_TechnicalCommittee | Proposal_TechnicalMembership | Proposal_Democracy | Proposal_Elections | Proposal_Scheduler | Proposal_Utility | Proposal_Identity | Proposal_Swork | Proposal_Market | Proposal_Claims | Proposal_Benefits | Proposal_Locks | Proposal_Sudo | Proposal_Multisig | Proposal_ChainBridge | Proposal_BridgeTransfer
...
export interface Proposal_Swork {
  __kind: 'Swork'
  value: SworkCall
}

export interface Proposal_Market {
  __kind: 'Market'
  value: MarketCall
}
...
export interface Proposal_Benefits {
  __kind: 'Benefits'
  value: BenefitsCall
}

export interface Proposal_Locks {
  __kind: 'Locks'
  value: LocksCall
}
...
export interface Proposal_BridgeTransfer {
...
export interface SworkCall_report_works {
  __kind: 'report_works'
  currPk: SworkerPubKey
  abUpgradePk: SworkerPubKey
  slot: bigint
  slotHash: Uint8Array
  reportedSrdSize: bigint
  reportedFilesSize: bigint
  addedFiles: [MerkleRoot, bigint, bigint][]
  deletedFiles: [MerkleRoot, bigint, bigint][]
  reportedSrdRoot: MerkleRoot
  reportedFilesRoot: MerkleRoot
  sig: SworkerSignature
}
...
export type BridgeTransferCall = BridgeTransferCall_sudo_change_fee | BridgeTransferCall_transfer_native | BridgeTransferCall_transfer_to_elrond | BridgeTransferCall_transfer
...
export type Type_117 = Type_117_System | Type_117_Babe | Type_117_Timestamp | Type_117_Indices | Type_117_Balances | Type_117_Authorship | Type_117_Staking | Type_117_Session | Type_117_Grandpa | Type_117_ImOnline | Type_117_AuthorityDiscovery | Type_117_Offences | Type_117_Treasury | Type_117_Tips | Type_117_Council | Type_117_TechnicalCommittee | Type_117_TechnicalMembership | Type_117_Democracy | Type_117_Elections | Type_117_Scheduler | Type_117_Utility | Type_117_Identity | Type_117_Swork | Type_117_Market | Type_117_Claims | Type_117_Benefits | Type_117_Locks | Type_117_Sudo | Type_117_Multisig | Type_117_ChainBridge | Type_117_BridgeTransfer

export interface Type_117_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_117_Babe {
  __kind: 'Babe'
  value: BabeCall
}

export interface Type_117_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_117_Indices {
  __kind: 'Indices'
  value: IndicesCall
}

export interface Type_117_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_117_Authorship {
  __kind: 'Authorship'
  value: AuthorshipCall
}

export interface Type_117_Staking {
  __kind: 'Staking'
  value: StakingCall
}

export interface Type_117_Session {
  __kind: 'Session'
  value: SessionCall
}

export interface Type_117_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaCall
}

export interface Type_117_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineCall
}

export interface Type_117_AuthorityDiscovery {
  __kind: 'AuthorityDiscovery'
  value: AuthorityDiscoveryCall
}

export interface Type_117_Offences {
  __kind: 'Offences'
  value: OffencesCall
}

export interface Type_117_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_117_Tips {
  __kind: 'Tips'
  value: TipsCall
}

export interface Type_117_Council {
  __kind: 'Council'
  value: CouncilCall
}

export interface Type_117_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeCall
}

export interface Type_117_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipCall
}

export interface Type_117_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_117_Elections {
  __kind: 'Elections'
  value: ElectionsCall
}

export interface Type_117_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_117_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_117_Identity {
  __kind: 'Identity'
  value: IdentityCall
}

export interface Type_117_Swork {
  __kind: 'Swork'
  value: SworkCall
}

export interface Type_117_Market {
  __kind: 'Market'
  value: MarketCall
}

export interface Type_117_Claims {
  __kind: 'Claims'
  value: ClaimsCall
}

export interface Type_117_Benefits {
  __kind: 'Benefits'
  value: BenefitsCall
}

export interface Type_117_Locks {
  __kind: 'Locks'
  value: LocksCall
}

export interface Type_117_Sudo {
  __kind: 'Sudo'
  value: SudoCall
}

export interface Type_117_Multisig {
  __kind: 'Multisig'
  value: MultisigCall
}

export interface Type_117_ChainBridge {
  __kind: 'ChainBridge'
  value: ChainBridgeCall
}

export interface Type_117_BridgeTransfer {
  __kind: 'BridgeTransfer'
  value: BridgeTransferCall
}
...
export type SworkerCode = Uint8Array

export type IASSig = Uint8Array

export type SworkerCert = Uint8Array

export type ISVBody = Uint8Array

export type SworkerSignature = Uint8Array

export type SworkerPubKey = Uint8Array

export type MerkleRoot = Uint8Array

export type EthereumTxHash = Uint8Array
