...
export type Proposal = Proposal_System | Proposal_RandomnessCollectiveFlip | Proposal_Babe | Proposal_Timestamp | Proposal_Grandpa | Proposal_Balances | Proposal_Sudo | Proposal_Scheduler | Proposal_Identity | Proposal_Authorship | Proposal_Staking | Proposal_Democracy | Proposal_ElectionProviderMultiPhase | Proposal_Treasury | Proposal_Session | Proposal_Elections | Proposal_Council | Proposal_TechnicalCommittee | Proposal_AuthorityDiscovery | Proposal_ImOnline | Proposal_Offences | Proposal_Tips | Proposal_Tokens | Proposal_Currencies | Proposal_AssetRegistry | Proposal_AMM | Proposal_Claims | Proposal_Exchange | Proposal_Faucet | Proposal_MultiTransactionPayment
