...
export interface Type_187_Parachains {
  __kind: 'Parachains'
  value: ParachainsCall
}

export interface Type_187_Attestations {
  __kind: 'Attestations'
  value: AttestationsCall
}

export interface Type_187_Slots {
  __kind: 'Slots'
  value: SlotsCall
}

export interface Type_187_Registrar {
  __kind: 'Registrar'
  value: RegistrarCall
}
