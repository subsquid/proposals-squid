...
export interface LiquidityMiningCall_create_mining_pool {
  ...
  mainReward: [CurrencyId, BalanceOf]
  optionRewards: [CurrencyId, BalanceOf][]
  duration: number
...
export type AccountIdOf = Uint8Array
