...
export class CouncilProposalOfStorage {
   ...
   */
  get isV29() {
    return this._chain.getStorageItemTypeHash('Council', 'ProposalOf') === '3192f29a2618555bd1d712b640211503f8b99ad53cdd8a1015408cf6c175aea2'
  }
  ...
  async getManyAsV29(keys: v29.H256[]): Promise<(v29.Call | undefined)[]> {
    assert(this.isV29)
...
export class DemocracyPreimagesStorage {
   ...
   *  The block number is the block at which it was deposited.
   */
  async getAsV13(key: v13.Hash): Promise<v13.PreimageStatus | undefined> {
    assert(this.isV13)
    return this._chain.getStorage(this.blockHash, 'Democracy', 'Preimages', key)
  }

  async getManyAsV13(keys: v13.Hash[]): Promise<(v13.PreimageStatus | undefined)[]> {
    assert(this.isV13)
  ...
  async getManyAsV29(keys: v29.H256[]): Promise<(v29.PreimageStatus | undefined)[]> {
    assert(this.isV29)
    return this._chain.queryStorage(this.blockHash, 'Democracy', 'Preimages', keys.map(k => [k]))
  }
...
export class DemocracyPublicPropsStorage {
   ...
   *  The public proposals. Unsorted. The second item is the proposal's hash.
   */
  async getAsV13(): Promise<[v13.PropIndex, v13.Hash, v13.AccountId][]> {
    assert(this.isV13)
...
export class DemocracyReferendumInfoOfStorage {
   ...
   *  TWOX-NOTE: SAFE as indexes are not under an attacker’s control.
   */
  async getAsV13(key: v13.ReferendumIndex): Promise<v13.ReferendumInfo | undefined> {
    assert(this.isV13)
    return this._chain.getStorage(this.blockHash, 'Democracy', 'ReferendumInfoOf', key)
  }

  async getManyAsV13(keys: v13.ReferendumIndex[]): Promise<(v13.ReferendumInfo | undefined)[]> {
    assert(this.isV13)
  ...
  async getManyAsV29(keys: number[]): Promise<(v29.ReferendumInfo | undefined)[]> {
    assert(this.isV29)
    return this._chain.queryStorage(this.blockHash, 'Democracy', 'ReferendumInfoOf', keys.map(k => [k]))
  }
...
export class Instance1CollectiveProposalOfStorage {
   ...
   */
  get isV13() {
    return this._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === 'e35e51bc2a99253fafbbd1a38a3fd280853e55c4f9ea52d83a61158053814a23'
  }
   ...
   */
  get isV14() {
    return this._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === '68e38565bbeb1e8dd8e05e83fb48d50d6855dd4b170859e9f578be3f63fa8d63'
  }
   ...
   */
  get isV22() {
    return this._chain.getStorageItemTypeHash('Instance1Collective', 'ProposalOf') === 'e4b57537ff43b25a42e329425097b898a68b17028632f36b55245f08d1857198'
  }

  /**
   *  Actual proposal for a given hash, if it's current.
   */
  async getAsV22(key: v22.Hash): Promise<v22.Proposal | undefined> {
    assert(this.isV22)
    return this._chain.getStorage(this.blockHash, 'Instance1Collective', 'ProposalOf', key)
  }

  async getManyAsV22(keys: v22.Hash[]): Promise<(v22.Proposal | undefined)[]> {
    assert(this.isV22)
    return this._chain.queryStorage(this.blockHash, 'Instance1Collective', 'ProposalOf', keys.map(k => [k]))
  }
...
export class Instance2CollectiveProposalOfStorage {
   ...
   */
  get isV13() {
    return this._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === 'e35e51bc2a99253fafbbd1a38a3fd280853e55c4f9ea52d83a61158053814a23'
  }
   ...
   */
  get isV14() {
    return this._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === '68e38565bbeb1e8dd8e05e83fb48d50d6855dd4b170859e9f578be3f63fa8d63'
  }
   ...
   */
  get isV22() {
    return this._chain.getStorageItemTypeHash('Instance2Collective', 'ProposalOf') === 'e4b57537ff43b25a42e329425097b898a68b17028632f36b55245f08d1857198'
  }
...
export class TechnicalCommitteeProposalOfStorage {
   ...
   */
  get isV29() {
    return this._chain.getStorageItemTypeHash('TechnicalCommittee', 'ProposalOf') === '3192f29a2618555bd1d712b640211503f8b99ad53cdd8a1015408cf6c175aea2'
  }
...
export class TipsTipsStorage {
  ...
  async getManyAsV29(keys: v29.H256[]): Promise<(v29.OpenTip | undefined)[]> {
    assert(this.isV29)
...
export class TreasuryProposalsStorage {
   ...
   *  Proposals that have been made.
   */
  async getAsV13(key: v13.ProposalIndex): Promise<v13.TreasuryProposal | undefined> {
    assert(this.isV13)
    return this._chain.getStorage(this.blockHash, 'Treasury', 'Proposals', key)
  }

  async getManyAsV13(keys: v13.ProposalIndex[]): Promise<(v13.TreasuryProposal | undefined)[]> {
    assert(this.isV13)
