...
export type V2Instruction_78 = V2Instruction_78_WithdrawAsset | V2Instruction_78_ReserveAssetDeposited | V2Instruction_78_ReceiveTeleportedAsset | V2Instruction_78_QueryResponse | V2Instruction_78_TransferAsset | V2Instruction_78_TransferReserveAsset | V2Instruction_78_Transact | V2Instruction_78_HrmpNewChannelOpenRequest | V2Instruction_78_HrmpChannelAccepted | V2Instruction_78_HrmpChannelClosing | V2Instruction_78_ClearOrigin | V2Instruction_78_DescendOrigin | V2Instruction_78_ReportError | V2Instruction_78_DepositAsset | V2Instruction_78_DepositReserveAsset | V2Instruction_78_ExchangeAsset | V2Instruction_78_InitiateReserveWithdraw | V2Instruction_78_InitiateTeleport | V2Instruction_78_QueryHolding | V2Instruction_78_BuyExecution | V2Instruction_78_RefundSurplus | V2Instruction_78_SetErrorHandler | V2Instruction_78_SetAppendix | V2Instruction_78_ClearError | V2Instruction_78_ClaimAsset | V2Instruction_78_Trap | V2Instruction_78_SubscribeVersion | V2Instruction_78_UnsubscribeVersion

export interface V2Instruction_78_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_78_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_78_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_78_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_78_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_78_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_78[]
}

export interface V2Instruction_78_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_78_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_78_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_78_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_78_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_78_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_78_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_78_DepositAsset {
  __kind: 'DepositAsset'
...
export interface V2Instruction_78_DepositReserveAsset {
...
export interface V2Instruction_78_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_78_InitiateReserveWithdraw {
...
export interface V2Instruction_78_InitiateTeleport {
...
export interface V2Instruction_78_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_78_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_78_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_78_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_78[]
}

export interface V2Instruction_78_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_78[]
}

export interface V2Instruction_78_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_78_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_78_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_78_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_78_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
