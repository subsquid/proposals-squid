...
export type Call = Call_System | Call_Timestamp | Call_Utility | Call_Multisig | Call_Proxy | Call_Vesting | Call_Scheduler | Call_Preimage | Call_ParachainSystem | Call_Balances | Call_Assets | Call_Authorship | Call_CollatorSelection | Call_Session | Call_Identity | Call_Democracy | Call_Council | Call_Treasury | Call_Bounties | Call_Lottery | Call_TechnicalCommittee | Call_TechnicalMembership | Call_PhragmenElection | Call_Tips | Call_ChildBounties | Call_Sudo
...
export type RawOrigin_195 = RawOrigin_195_Root | RawOrigin_195_Signed | RawOrigin_195_None

export interface RawOrigin_195_Root {
  __kind: 'Root'
}

export interface RawOrigin_195_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_195_None {
  __kind: 'None'
}

export type RawOrigin_196 = RawOrigin_196_Members | RawOrigin_196_Member | RawOrigin_196__Phantom

export interface RawOrigin_196_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_196_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_196__Phantom {
  __kind: '_Phantom'
}
