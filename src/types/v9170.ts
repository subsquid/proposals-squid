...
export type Phase_148 = Phase_148_ApplyExtrinsic | Phase_148_Finalization | Phase_148_Initialization

export interface Phase_148_ApplyExtrinsic {
  __kind: 'ApplyExtrinsic'
  value: number
}

export interface Phase_148_Finalization {
  __kind: 'Finalization'
}

export interface Phase_148_Initialization {
...
export interface XcmPalletEvent_Sent {
  __kind: 'Sent'
  value: [V1MultiLocation, V1MultiLocation, V2Instruction_124[]]
}
