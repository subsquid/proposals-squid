...
export type RawOrigin_114 = RawOrigin_114_Root | RawOrigin_114_Signed | RawOrigin_114_None

export interface RawOrigin_114_Root {
  __kind: 'Root'
}

export interface RawOrigin_114_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_114_None {
  __kind: 'None'
}

export type Origin_115 = Origin_115_Xcm | Origin_115_Response

export interface Origin_115_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_115_Response {
  __kind: 'Response'
  value: V1MultiLocation
}

export type Origin_116 = Origin_116_Relay | Origin_116_SiblingParachain

export interface Origin_116_Relay {
  __kind: 'Relay'
}

export interface Origin_116_SiblingParachain {
...
export type RawOrigin_118 = RawOrigin_118_Members | RawOrigin_118_Member | RawOrigin_118__Phantom

export interface RawOrigin_118_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_118_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_118__Phantom {
  __kind: '_Phantom'
}
