...
export type RawOrigin_186 = RawOrigin_186_Root | RawOrigin_186_Signed | RawOrigin_186_None

export interface RawOrigin_186_Root {
  __kind: 'Root'
}

export interface RawOrigin_186_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_186_None {
  __kind: 'None'
}

export type RawOrigin_187 = RawOrigin_187_Members | RawOrigin_187_Member | RawOrigin_187__Phantom

export interface RawOrigin_187_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_187_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_187__Phantom {
  __kind: '_Phantom'
}
