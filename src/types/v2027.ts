...
export type Type_330 = Type_330_System | Type_330_Indices | Type_330_Balances | Type_330_Staking | Type_330_Offences | Type_330_Session | Type_330_Grandpa | Type_330_ImOnline | Type_330_Democracy | Type_330_Council | Type_330_TechnicalCommittee | Type_330_ElectionsPhragmen | Type_330_TechnicalMembership | Type_330_Treasury | Type_330_Claims | Type_330_Utility | Type_330_Identity | Type_330_Society | Type_330_Recovery | Type_330_Vesting | Type_330_Scheduler | Type_330_Proxy | Type_330_Multisig

export interface Type_330_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_330_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_330_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_330_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_330_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_330_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_330_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_330_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_330_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_330_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_330_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_330_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenEvent
}

export interface Type_330_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_330_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_330_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_330_Utility {
  __kind: 'Utility'
  value: UtilityEvent
}

export interface Type_330_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}

export interface Type_330_Society {
  __kind: 'Society'
  value: SocietyEvent
}

export interface Type_330_Recovery {
  __kind: 'Recovery'
  value: RecoveryEvent
}

export interface Type_330_Vesting {
  __kind: 'Vesting'
  value: VestingEvent
}

export interface Type_330_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerEvent
}

export interface Type_330_Proxy {
  __kind: 'Proxy'
  value: ProxyEvent
}

export interface Type_330_Multisig {
  __kind: 'Multisig'
  value: MultisigEvent
}
