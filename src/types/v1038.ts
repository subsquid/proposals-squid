...
export type Type_251 = Type_251_System | Type_251_Indices | Type_251_Balances | Type_251_Staking | Type_251_Offences | Type_251_Session | Type_251_Grandpa | Type_251_ImOnline | Type_251_Democracy | Type_251_Council | Type_251_TechnicalCommittee | Type_251_ElectionsPhragmen | Type_251_TechnicalMembership | Type_251_Treasury | Type_251_Claims | Type_251_Slots | Type_251_Registrar | Type_251_Utility | Type_251_Identity

export interface Type_251_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_251_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_251_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_251_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_251_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_251_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_251_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_251_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_251_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_251_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_251_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_251_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenEvent
}

export interface Type_251_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_251_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_251_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_251_Slots {
  __kind: 'Slots'
  value: SlotsEvent
}

export interface Type_251_Registrar {
  __kind: 'Registrar'
  value: RegistrarEvent
}

export interface Type_251_Utility {
  __kind: 'Utility'
  value: UtilityEvent
}

export interface Type_251_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}
