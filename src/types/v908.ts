...
export type VersionedXcm_264 = VersionedXcm_264_V0 | VersionedXcm_264_V1 | VersionedXcm_264_V2

export interface VersionedXcm_264_V0 {
  __kind: 'V0'
  value: V0Xcm_265
}

export interface VersionedXcm_264_V1 {
  __kind: 'V1'
  value: V1Xcm_270
}

export interface VersionedXcm_264_V2 {
  __kind: 'V2'
  value: V2Instruction_276[]
}
...
export type V0Xcm_265 = V0Xcm_265_WithdrawAsset | V0Xcm_265_ReserveAssetDeposit | V0Xcm_265_TeleportAsset | V0Xcm_265_QueryResponse | V0Xcm_265_TransferAsset | V0Xcm_265_TransferReserveAsset | V0Xcm_265_Transact | V0Xcm_265_HrmpNewChannelOpenRequest | V0Xcm_265_HrmpChannelAccepted | V0Xcm_265_HrmpChannelClosing | V0Xcm_265_RelayedFrom

export interface V0Xcm_265_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_267[]
}

export interface V0Xcm_265_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_267[]
}

export interface V0Xcm_265_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_267[]
}

export interface V0Xcm_265_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_265_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_265_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_256[]
...
export interface V0Xcm_265_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V0Xcm_265_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V0Xcm_265_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_265_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V0Xcm_265_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_265
}

export type V1Xcm_270 = V1Xcm_270_WithdrawAsset | V1Xcm_270_ReserveAssetDeposited | V1Xcm_270_ReceiveTeleportedAsset | V1Xcm_270_QueryResponse | V1Xcm_270_TransferAsset | V1Xcm_270_TransferReserveAsset | V1Xcm_270_Transact | V1Xcm_270_HrmpNewChannelOpenRequest | V1Xcm_270_HrmpChannelAccepted | V1Xcm_270_HrmpChannelClosing | V1Xcm_270_RelayedFrom | V1Xcm_270_SubscribeVersion | V1Xcm_270_UnsubscribeVersion

export interface V1Xcm_270_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_272[]
}

export interface V1Xcm_270_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_272[]
}

export interface V1Xcm_270_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_272[]
}

export interface V1Xcm_270_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_270_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_270_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  effects: V1Order_261[]
...
export interface V1Xcm_270_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_270_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_270_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_270_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_270_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_270
}

export interface V1Xcm_270_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_270_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_276 = V2Instruction_276_WithdrawAsset | V2Instruction_276_ReserveAssetDeposited | V2Instruction_276_ReceiveTeleportedAsset | V2Instruction_276_QueryResponse | V2Instruction_276_TransferAsset | V2Instruction_276_TransferReserveAsset | V2Instruction_276_Transact | V2Instruction_276_HrmpNewChannelOpenRequest | V2Instruction_276_HrmpChannelAccepted | V2Instruction_276_HrmpChannelClosing | V2Instruction_276_ClearOrigin | V2Instruction_276_DescendOrigin | V2Instruction_276_ReportError | V2Instruction_276_DepositAsset | V2Instruction_276_DepositReserveAsset | V2Instruction_276_ExchangeAsset | V2Instruction_276_InitiateReserveWithdraw | V2Instruction_276_InitiateTeleport | V2Instruction_276_QueryHolding | V2Instruction_276_BuyExecution | V2Instruction_276_RefundSurplus | V2Instruction_276_SetErrorHandler | V2Instruction_276_SetAppendix | V2Instruction_276_ClearError | V2Instruction_276_ClaimAsset | V2Instruction_276_Trap | V2Instruction_276_SubscribeVersion | V2Instruction_276_UnsubscribeVersion

export interface V2Instruction_276_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_276_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_276_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_276_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_276_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_276_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_64[]
...
export interface V2Instruction_276_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_276_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_276_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_276_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_276_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_276_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_276_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_276_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_276_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_276_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_276_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_64[]
...
export interface V2Instruction_276_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_64[]
...
export interface V2Instruction_276_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_276_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_276_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_276_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_276[]
}

export interface V2Instruction_276_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_276[]
}

export interface V2Instruction_276_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_276_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_276_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_276_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_276_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export type V0Order_267 = V0Order_267_Null | V0Order_267_DepositAsset | V0Order_267_DepositReserveAsset | V0Order_267_ExchangeAsset | V0Order_267_InitiateReserveWithdraw | V0Order_267_InitiateTeleport | V0Order_267_QueryHolding | V0Order_267_BuyExecution

export interface V0Order_267_Null {
  __kind: 'Null'
}

export interface V0Order_267_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_267_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_256[]
...
export interface V0Order_267_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_267_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
  reserve: V0MultiLocation
  effects: V0Order_256[]
...
export interface V0Order_267_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_256[]
...
export interface V0Order_267_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_267_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_272 = V1Order_272_Noop | V1Order_272_DepositAsset | V1Order_272_DepositReserveAsset | V1Order_272_ExchangeAsset | V1Order_272_InitiateReserveWithdraw | V1Order_272_InitiateTeleport | V1Order_272_QueryHolding | V1Order_272_BuyExecution

export interface V1Order_272_Noop {
  __kind: 'Noop'
}

export interface V1Order_272_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_272_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_272_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_272_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_261[]
...
export interface V1Order_272_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_261[]
...
export interface V1Order_272_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_272_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_270[]
}
