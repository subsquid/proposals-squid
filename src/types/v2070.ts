...
export interface CdpEngineCall_set_collateral_params {
  ...
  currencyId: CurrencyId
  interestRatePerSec: Change_312
  liquidationRatio: Change_312
  liquidationPenalty: Change_312
  requiredCollateralRatio: Change_312
  maximumTotalDebitValue: Change_313
}
...
export type Change_312 = Change_312_NoChange | Change_312_NewValue

export interface Change_312_NoChange {
  __kind: 'NoChange'
}

export interface Change_312_NewValue {
  __kind: 'NewValue'
...
export type V2Instruction_273 = V2Instruction_273_WithdrawAsset | V2Instruction_273_ReserveAssetDeposited | V2Instruction_273_ReceiveTeleportedAsset | V2Instruction_273_QueryResponse | V2Instruction_273_TransferAsset | V2Instruction_273_TransferReserveAsset | V2Instruction_273_Transact | V2Instruction_273_HrmpNewChannelOpenRequest | V2Instruction_273_HrmpChannelAccepted | V2Instruction_273_HrmpChannelClosing | V2Instruction_273_ClearOrigin | V2Instruction_273_DescendOrigin | V2Instruction_273_ReportError | V2Instruction_273_DepositAsset | V2Instruction_273_DepositReserveAsset | V2Instruction_273_ExchangeAsset | V2Instruction_273_InitiateReserveWithdraw | V2Instruction_273_InitiateTeleport | V2Instruction_273_QueryHolding | V2Instruction_273_BuyExecution | V2Instruction_273_RefundSurplus | V2Instruction_273_SetErrorHandler | V2Instruction_273_SetAppendix | V2Instruction_273_ClearError | V2Instruction_273_ClaimAsset | V2Instruction_273_Trap | V2Instruction_273_SubscribeVersion | V2Instruction_273_UnsubscribeVersion

export interface V2Instruction_273_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_273_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_273_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_273_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_273_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_273_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_84[]
...
export interface V2Instruction_273_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_273_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_273_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_273_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_273_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_273_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_273_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_273_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_273_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_273_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_273_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_84[]
...
export interface V2Instruction_273_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_84[]
...
export interface V2Instruction_273_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_273_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_273_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_273_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_273[]
}

export interface V2Instruction_273_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_273[]
}

export interface V2Instruction_273_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_273_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_273_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_273_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_273_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
