...
export type VersionedXcm_265 = VersionedXcm_265_V0 | VersionedXcm_265_V1 | VersionedXcm_265_V2

export interface VersionedXcm_265_V0 {
  __kind: 'V0'
  value: V0Xcm_266
}

export interface VersionedXcm_265_V1 {
  __kind: 'V1'
  value: V1Xcm_271
}

export interface VersionedXcm_265_V2 {
  __kind: 'V2'
  value: V2Instruction_277[]
}
...
export type V0Xcm_266 = V0Xcm_266_WithdrawAsset | V0Xcm_266_ReserveAssetDeposit | V0Xcm_266_TeleportAsset | V0Xcm_266_QueryResponse | V0Xcm_266_TransferAsset | V0Xcm_266_TransferReserveAsset | V0Xcm_266_Transact | V0Xcm_266_HrmpNewChannelOpenRequest | V0Xcm_266_HrmpChannelAccepted | V0Xcm_266_HrmpChannelClosing | V0Xcm_266_RelayedFrom

export interface V0Xcm_266_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_268[]
}

export interface V0Xcm_266_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_268[]
}

export interface V0Xcm_266_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_268[]
}

export interface V0Xcm_266_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_266_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_266_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_257[]
...
export interface V0Xcm_266_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V0Xcm_266_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V0Xcm_266_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_266_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V0Xcm_266_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_266
}

export type V1Xcm_271 = V1Xcm_271_WithdrawAsset | V1Xcm_271_ReserveAssetDeposited | V1Xcm_271_ReceiveTeleportedAsset | V1Xcm_271_QueryResponse | V1Xcm_271_TransferAsset | V1Xcm_271_TransferReserveAsset | V1Xcm_271_Transact | V1Xcm_271_HrmpNewChannelOpenRequest | V1Xcm_271_HrmpChannelAccepted | V1Xcm_271_HrmpChannelClosing | V1Xcm_271_RelayedFrom | V1Xcm_271_SubscribeVersion | V1Xcm_271_UnsubscribeVersion

export interface V1Xcm_271_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_273[]
}

export interface V1Xcm_271_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_273[]
}

export interface V1Xcm_271_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_273[]
}

export interface V1Xcm_271_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_271_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_271_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  effects: V1Order_262[]
...
export interface V1Xcm_271_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_271_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_271_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_271_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_271_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_271
}

export interface V1Xcm_271_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_271_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_277 = V2Instruction_277_WithdrawAsset | V2Instruction_277_ReserveAssetDeposited | V2Instruction_277_ReceiveTeleportedAsset | V2Instruction_277_QueryResponse | V2Instruction_277_TransferAsset | V2Instruction_277_TransferReserveAsset | V2Instruction_277_Transact | V2Instruction_277_HrmpNewChannelOpenRequest | V2Instruction_277_HrmpChannelAccepted | V2Instruction_277_HrmpChannelClosing | V2Instruction_277_ClearOrigin | V2Instruction_277_DescendOrigin | V2Instruction_277_ReportError | V2Instruction_277_DepositAsset | V2Instruction_277_DepositReserveAsset | V2Instruction_277_ExchangeAsset | V2Instruction_277_InitiateReserveWithdraw | V2Instruction_277_InitiateTeleport | V2Instruction_277_QueryHolding | V2Instruction_277_BuyExecution | V2Instruction_277_RefundSurplus | V2Instruction_277_SetErrorHandler | V2Instruction_277_SetAppendix | V2Instruction_277_ClearError | V2Instruction_277_ClaimAsset | V2Instruction_277_Trap | V2Instruction_277_SubscribeVersion | V2Instruction_277_UnsubscribeVersion

export interface V2Instruction_277_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_277_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_277_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_277_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_277_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_277_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_64[]
...
export interface V2Instruction_277_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_277_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_277_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_277_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_277_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_277_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_277_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_277_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_277_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_277_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_277_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_64[]
...
export interface V2Instruction_277_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_64[]
...
export interface V2Instruction_277_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_277_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_277_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_277_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_277[]
}

export interface V2Instruction_277_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_277[]
}

export interface V2Instruction_277_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_277_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_277_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_277_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_277_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export type V0Order_268 = V0Order_268_Null | V0Order_268_DepositAsset | V0Order_268_DepositReserveAsset | V0Order_268_ExchangeAsset | V0Order_268_InitiateReserveWithdraw | V0Order_268_InitiateTeleport | V0Order_268_QueryHolding | V0Order_268_BuyExecution

export interface V0Order_268_Null {
  __kind: 'Null'
}

export interface V0Order_268_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_268_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_257[]
...
export interface V0Order_268_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_268_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
  reserve: V0MultiLocation
  effects: V0Order_257[]
...
export interface V0Order_268_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_257[]
...
export interface V0Order_268_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_268_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_273 = V1Order_273_Noop | V1Order_273_DepositAsset | V1Order_273_DepositReserveAsset | V1Order_273_ExchangeAsset | V1Order_273_InitiateReserveWithdraw | V1Order_273_InitiateTeleport | V1Order_273_QueryHolding | V1Order_273_BuyExecution

export interface V1Order_273_Noop {
  __kind: 'Noop'
}

export interface V1Order_273_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_273_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_273_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_273_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_262[]
...
export interface V1Order_273_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_262[]
...
export interface V1Order_273_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_273_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_271[]
}
