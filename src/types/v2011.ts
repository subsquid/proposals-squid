...
export type RawOrigin_106 = RawOrigin_106_Root | RawOrigin_106_Signed | RawOrigin_106_None

export interface RawOrigin_106_Root {
  __kind: 'Root'
}

export interface RawOrigin_106_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_106_None {
  __kind: 'None'
}

export type Origin_107 = Origin_107_Xcm | Origin_107_Response

export interface Origin_107_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_107_Response {
  __kind: 'Response'
  value: V1MultiLocation
}

export type Origin_108 = Origin_108_Relay | Origin_108_SiblingParachain

export interface Origin_108_Relay {
  __kind: 'Relay'
}

export interface Origin_108_SiblingParachain {
...
export type RawOrigin_111 = RawOrigin_111_Members | RawOrigin_111_Member | RawOrigin_111__Phantom

export interface RawOrigin_111_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_111_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_111__Phantom {
  __kind: '_Phantom'
}
