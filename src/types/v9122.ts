...
export type RawOrigin_576 = RawOrigin_576_Root | RawOrigin_576_Signed | RawOrigin_576_None

export interface RawOrigin_576_Root {
  __kind: 'Root'
}

export interface RawOrigin_576_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_576_None {
  __kind: 'None'
}

export type RawOrigin_577 = RawOrigin_577_Members | RawOrigin_577_Member | RawOrigin_577__Phantom

export interface RawOrigin_577_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_577_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_577__Phantom {
  __kind: '_Phantom'
}

export type Origin_579 = Origin_579_Parachain

export interface Origin_579_Parachain {
  __kind: 'Parachain'
  value: Id
}

export type Origin_580 = Origin_580_Xcm | Origin_580_Response

export interface Origin_580_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_580_Response {
  __kind: 'Response'
  value: V1MultiLocation
}
