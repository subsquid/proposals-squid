...
export type Type_101 = Type_101_System | Type_101_Babe | Type_101_Timestamp | Type_101_Indices | Type_101_Balances | Type_101_Authorship | Type_101_Staking | Type_101_Offences | Type_101_Session | Type_101_FinalityTracker | Type_101_Grandpa | Type_101_ImOnline | Type_101_AuthorityDiscovery | Type_101_Democracy | Type_101_Council | Type_101_TechnicalCommittee | Type_101_ElectionsPhragmen | Type_101_TechnicalMembership | Type_101_Treasury | Type_101_Claims | Type_101_Parachains | Type_101_Attestations | Type_101_Slots | Type_101_Registrar | Type_101_Sudo | Type_101_Nicks

export interface Type_101_System {
  __kind: 'System'
  value: SystemCall
}

export interface Type_101_Babe {
  __kind: 'Babe'
  value: BabeCall
}

export interface Type_101_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}

export interface Type_101_Indices {
  __kind: 'Indices'
  value: IndicesCall
}

export interface Type_101_Balances {
  __kind: 'Balances'
  value: BalancesCall
}

export interface Type_101_Authorship {
  __kind: 'Authorship'
  value: AuthorshipCall
}

export interface Type_101_Staking {
  __kind: 'Staking'
  value: StakingCall
}

export interface Type_101_Offences {
  __kind: 'Offences'
  value: OffencesCall
}

export interface Type_101_Session {
  __kind: 'Session'
  value: SessionCall
}

export interface Type_101_FinalityTracker {
  __kind: 'FinalityTracker'
  value: FinalityTrackerCall
}

export interface Type_101_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaCall
}

export interface Type_101_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineCall
}

export interface Type_101_AuthorityDiscovery {
  __kind: 'AuthorityDiscovery'
  value: AuthorityDiscoveryCall
}

export interface Type_101_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_101_Council {
  __kind: 'Council'
  value: CouncilCall
}

export interface Type_101_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeCall
}

export interface Type_101_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenCall
}

export interface Type_101_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipCall
}

export interface Type_101_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_101_Claims {
  __kind: 'Claims'
  value: ClaimsCall
}

export interface Type_101_Parachains {
  __kind: 'Parachains'
  value: ParachainsCall
}

export interface Type_101_Attestations {
  __kind: 'Attestations'
  value: AttestationsCall
}

export interface Type_101_Slots {
  __kind: 'Slots'
  value: SlotsCall
}

export interface Type_101_Registrar {
  __kind: 'Registrar'
  value: RegistrarCall
}

export interface Type_101_Sudo {
  __kind: 'Sudo'
  value: SudoCall
}

export interface Type_101_Nicks {
  __kind: 'Nicks'
  value: NicksCall
}
