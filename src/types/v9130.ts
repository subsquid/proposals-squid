...
export type Phase_143 = Phase_143_ApplyExtrinsic | Phase_143_Finalization | Phase_143_Initialization

export interface Phase_143_ApplyExtrinsic {
  __kind: 'ApplyExtrinsic'
  value: number
}

export interface Phase_143_Finalization {
  __kind: 'Finalization'
}

export interface Phase_143_Initialization {
...
export interface XcmPalletEvent_Sent {
  __kind: 'Sent'
  value: [V1MultiLocation, V1MultiLocation, V2Instruction_119[]]
}
