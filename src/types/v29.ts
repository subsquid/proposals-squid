...
export type Call = Call_System | Call_Babe | Call_Timestamp | Call_Grandpa | Call_Balances | Call_Sudo | Call_Scheduler | Call_Identity | Call_Preimage | Call_Authorship | Call_Staking | Call_Democracy | Call_ElectionProviderMultiPhase | Call_Treasury | Call_Session | Call_Elections | Call_Council | Call_TechnicalCommittee | Call_ImOnline | Call_Tips | Call_Utility | Call_Tokens | Call_Currencies | Call_Vesting | Call_Claims | Call_Faucet | Call_MultiTransactionPayment
...
export interface BabeCall_report_equivocation {
  ...
  equivocationProof: EquivocationProof_120
...
export interface GrandpaCall_report_equivocation {
  __kind: 'report_equivocation'
  equivocationProof: EquivocationProof_132
  keyOwnerProof: MembershipProof
}
...
export interface EquivocationProof_120 {
  offender: Public
  slot: Slot
  firstHeader: Header
  secondHeader: Header
...
export interface EquivocationProof_132 {
  setId: bigint
  equivocation: Equivocation_133
}
...
export type Equivocation_133 = Equivocation_133_Prevote | Equivocation_133_Precommit

export interface Equivocation_133_Prevote {
  __kind: 'Prevote'
  value: Equivocation_134
}

export interface Equivocation_133_Precommit {
  __kind: 'Precommit'
  value: Equivocation_134
}
...
export type RawOrigin_294 = RawOrigin_294_Root | RawOrigin_294_Signed | RawOrigin_294_None

export interface RawOrigin_294_Root {
  __kind: 'Root'
}

export interface RawOrigin_294_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_294_None {
  __kind: 'None'
}

export type RawOrigin_295 = RawOrigin_295_Members | RawOrigin_295_Member | RawOrigin_295__Phantom

export interface RawOrigin_295_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_295_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_295__Phantom {
  __kind: '_Phantom'
}

export type Void = never

export interface Equivocation_134 {
  roundNumber: bigint
  identity: Public
