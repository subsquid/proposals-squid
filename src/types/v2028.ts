...
export type Type_336 = Type_336_System | Type_336_Indices | Type_336_Balances | Type_336_Staking | Type_336_Offences | Type_336_Session | Type_336_Grandpa | Type_336_ImOnline | Type_336_Democracy | Type_336_Council | Type_336_TechnicalCommittee | Type_336_ElectionsPhragmen | Type_336_TechnicalMembership | Type_336_Treasury | Type_336_Claims | Type_336_Utility | Type_336_Identity | Type_336_Society | Type_336_Recovery | Type_336_Vesting | Type_336_Scheduler | Type_336_Proxy | Type_336_Multisig | Type_336_Bounties | Type_336_Tips

export interface Type_336_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_336_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_336_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_336_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_336_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_336_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_336_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_336_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_336_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_336_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_336_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_336_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenEvent
}

export interface Type_336_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_336_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_336_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_336_Utility {
  __kind: 'Utility'
  value: UtilityEvent
}

export interface Type_336_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}

export interface Type_336_Society {
  __kind: 'Society'
  value: SocietyEvent
}

export interface Type_336_Recovery {
  __kind: 'Recovery'
  value: RecoveryEvent
}

export interface Type_336_Vesting {
  __kind: 'Vesting'
  value: VestingEvent
}

export interface Type_336_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerEvent
}

export interface Type_336_Proxy {
  __kind: 'Proxy'
  value: ProxyEvent
}

export interface Type_336_Multisig {
  __kind: 'Multisig'
  value: MultisigEvent
}

export interface Type_336_Bounties {
  __kind: 'Bounties'
  value: BountiesEvent
}

export interface Type_336_Tips {
  __kind: 'Tips'
  value: TipsEvent
}
