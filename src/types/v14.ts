...
export type Proposal = Proposal_System | Proposal_RandomnessCollectiveFlip | Proposal_Babe | Proposal_Timestamp | Proposal_Grandpa | Proposal_Balances | Proposal_Sudo | Proposal_Scheduler | Proposal_Identity | Proposal_Authorship | Proposal_Staking | Proposal_Democracy | Proposal_ElectionProviderMultiPhase | Proposal_Treasury | Proposal_Session | Proposal_Elections | Proposal_Council | Proposal_TechnicalCommittee | Proposal_AuthorityDiscovery | Proposal_ImOnline | Proposal_Offences | Proposal_Tips | Proposal_Utility | Proposal_Tokens | Proposal_Currencies | Proposal_AssetRegistry | Proposal_XYK | Proposal_Claims | Proposal_Exchange | Proposal_Faucet | Proposal_MultiTransactionPayment
...
export type Type_86 = Type_86_System | Type_86_RandomnessCollectiveFlip | Type_86_Babe | Type_86_Timestamp | Type_86_Grandpa | Type_86_Balances | Type_86_Sudo | Type_86_Scheduler | Type_86_Identity | Type_86_Authorship | Type_86_Staking | Type_86_Democracy | Type_86_ElectionProviderMultiPhase | Type_86_Treasury | Type_86_Session | Type_86_Elections | Type_86_Council | Type_86_TechnicalCommittee | Type_86_AuthorityDiscovery | Type_86_ImOnline | Type_86_Offences | Type_86_Tips | Type_86_Utility | Type_86_Tokens | Type_86_Currencies | Type_86_AssetRegistry | Type_86_XYK | Type_86_Claims | Type_86_Exchange | Type_86_Faucet | Type_86_MultiTransactionPayment
...
export interface Type_86_RandomnessCollectiveFlip {
  __kind: 'RandomnessCollectiveFlip'
  value: RandomnessCollectiveFlipCall
}

export interface Type_86_Babe {
  __kind: 'Babe'
  value: BabeCall
}

export interface Type_86_Timestamp {
  __kind: 'Timestamp'
  value: TimestampCall
}
...
export interface Type_86_Scheduler {
  __kind: 'Scheduler'
  value: SchedulerCall
}

export interface Type_86_Identity {
  __kind: 'Identity'
  value: IdentityCall
}

export interface Type_86_Authorship {
  __kind: 'Authorship'
  value: AuthorshipCall
}

export interface Type_86_Staking {
  __kind: 'Staking'
  value: StakingCall
}

export interface Type_86_Democracy {
  __kind: 'Democracy'
  value: DemocracyCall
}

export interface Type_86_ElectionProviderMultiPhase {
  __kind: 'ElectionProviderMultiPhase'
  value: ElectionProviderMultiPhaseCall
}

export interface Type_86_Treasury {
  __kind: 'Treasury'
  value: TreasuryCall
}

export interface Type_86_Session {
  __kind: 'Session'
  value: SessionCall
}

export interface Type_86_Elections {
  __kind: 'Elections'
  value: ElectionsCall
}

export interface Type_86_Council {
  __kind: 'Council'
  value: CouncilCall
}

export interface Type_86_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeCall
}

export interface Type_86_AuthorityDiscovery {
  __kind: 'AuthorityDiscovery'
  value: AuthorityDiscoveryCall
}

export interface Type_86_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineCall
}

export interface Type_86_Offences {
  __kind: 'Offences'
  value: OffencesCall
}

export interface Type_86_Tips {
  __kind: 'Tips'
  value: TipsCall
}

export interface Type_86_Utility {
  __kind: 'Utility'
  value: UtilityCall
}

export interface Type_86_Tokens {
  __kind: 'Tokens'
  value: TokensCall
}

export interface Type_86_Currencies {
  __kind: 'Currencies'
  value: CurrenciesCall
}

export interface Type_86_AssetRegistry {
  __kind: 'AssetRegistry'
  value: AssetRegistryCall
}

export interface Type_86_XYK {
  __kind: 'XYK'
  value: XYKCall
}

export interface Type_86_Claims {
  __kind: 'Claims'
  value: ClaimsCall
}

export interface Type_86_Exchange {
  __kind: 'Exchange'
  value: ExchangeCall
}

export interface Type_86_Faucet {
  __kind: 'Faucet'
  value: FaucetCall
}

export interface Type_86_MultiTransactionPayment {
  __kind: 'MultiTransactionPayment'
  value: MultiTransactionPaymentCall
}
...
export type CurrencyIdOf = number
