...
export class CouncilClosedEvent {
   ...
   *  \[proposal_hash, yes, no\]
   */
  get asV13(): [v13.Hash, v13.MemberCount, v13.MemberCount] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class CouncilExecutedEvent {
   ...
   *  \[proposal_hash, result\]
   */
  get asV13(): [v13.Hash, v13.DispatchResult] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class CouncilProposedEvent {
   ...
   *  \[account, proposal_index, proposal_hash, threshold\]
   */
  get asV13(): [v13.AccountId, v13.ProposalIndex, v13.Hash, v13.MemberCount] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class CouncilVotedEvent {
   ...
   *  \[account, proposal_hash, voted, yes, no\]
   */
  get asV13(): [v13.AccountId, v13.Hash, boolean, v13.MemberCount, v13.MemberCount] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyExecutedEvent {
   ...
   *  A proposal has been enacted. \[ref_index, is_ok\]
   */
  get asV13(): [v13.ReferendumIndex, boolean] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyPreimageInvalidEvent {
   ...
   *  \[proposal_hash, ref_index\]
   */
  get asV13(): [v13.Hash, v13.ReferendumIndex] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyPreimageNotedEvent {
   ...
   *  A proposal's preimage was noted, and the deposit taken. \[proposal_hash, who, deposit\]
   */
  get asV13(): [v13.Hash, v13.AccountId, v13.Balance] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyPreimageReapedEvent {
   ...
   *  \[proposal_hash, provider, deposit, reaper\]
   */
  get asV13(): [v13.Hash, v13.AccountId, v13.Balance, v13.AccountId] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyProposedEvent {
   ...
   *  A motion has been proposed by a public account. \[proposal_index, deposit\]
   */
  get asV13(): [v13.PropIndex, v13.Balance] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyStartedEvent {
   ...
   *  A referendum has begun. \[ref_index, threshold\]
   */
  get asV13(): [v13.ReferendumIndex, v13.VoteThreshold] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class DemocracyTabledEvent {
   ...
   *  A public proposal has been tabled for referendum vote. \[proposal_index, deposit, depositors\]
   */
  get asV13(): [v13.PropIndex, v13.Balance, v13.AccountId[]] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class TreasuryAwardedEvent {
   ...
   *  Some funds have been allocated. \[proposal_index, award, beneficiary\]
   */
  get asV13(): [v13.ProposalIndex, v13.Balance, v13.AccountId] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
...
export class TreasuryRejectedEvent {
   ...
   *  A proposal was rejected; funds were slashed. \[proposal_index, slashed\]
   */
  get asV13(): [v13.ProposalIndex, v13.Balance] {
    assert(this.isV13)
    return this._chain.decodeEvent(this.event)
  }
