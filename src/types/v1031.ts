...
export type Type_246 = Type_246_System | Type_246_Indices | Type_246_Balances | Type_246_Staking | Type_246_Offences | Type_246_Session | Type_246_Grandpa | Type_246_ImOnline | Type_246_Democracy | Type_246_Council | Type_246_TechnicalCommittee | Type_246_ElectionsPhragmen | Type_246_TechnicalMembership | Type_246_Treasury | Type_246_Claims | Type_246_Slots | Type_246_Registrar | Type_246_Nicks | Type_246_Identity

export interface Type_246_System {
  __kind: 'System'
  value: SystemEvent
}

export interface Type_246_Indices {
  __kind: 'Indices'
  value: IndicesEvent
}

export interface Type_246_Balances {
  __kind: 'Balances'
  value: BalancesEvent
}

export interface Type_246_Staking {
  __kind: 'Staking'
  value: StakingEvent
}

export interface Type_246_Offences {
  __kind: 'Offences'
  value: OffencesEvent
}

export interface Type_246_Session {
  __kind: 'Session'
  value: SessionEvent
}

export interface Type_246_Grandpa {
  __kind: 'Grandpa'
  value: GrandpaEvent
}

export interface Type_246_ImOnline {
  __kind: 'ImOnline'
  value: ImOnlineEvent
}

export interface Type_246_Democracy {
  __kind: 'Democracy'
  value: DemocracyEvent
}

export interface Type_246_Council {
  __kind: 'Council'
  value: CouncilEvent
}

export interface Type_246_TechnicalCommittee {
  __kind: 'TechnicalCommittee'
  value: TechnicalCommitteeEvent
}

export interface Type_246_ElectionsPhragmen {
  __kind: 'ElectionsPhragmen'
  value: ElectionsPhragmenEvent
}

export interface Type_246_TechnicalMembership {
  __kind: 'TechnicalMembership'
  value: TechnicalMembershipEvent
}

export interface Type_246_Treasury {
  __kind: 'Treasury'
  value: TreasuryEvent
}

export interface Type_246_Claims {
  __kind: 'Claims'
  value: ClaimsEvent
}

export interface Type_246_Slots {
  __kind: 'Slots'
  value: SlotsEvent
}

export interface Type_246_Registrar {
  __kind: 'Registrar'
  value: RegistrarEvent
}

export interface Type_246_Nicks {
  __kind: 'Nicks'
  value: NicksEvent
}

export interface Type_246_Identity {
  __kind: 'Identity'
  value: IdentityEvent
}
