...
processor.addEventHandler('treasury.Closed', modules.tips.events.handleClosed)
processor.addEventHandler('treasury.Retracted', modules.tips.events.handleRetracted)
processor.addEventHandler('treasury.Slashed', modules.tips.events.handleSlashed)

processor.addEventHandler('tips.NewTip', modules.tips.events.handleNewTip)
processor.addEventHandler('tips.Closed', modules.tips.events.handleClosed)
processor.addEventHandler('tips.Retracted', modules.tips.events.handleRetracted)
processor.addEventHandler('tips.Slashed', modules.tips.events.handleSlashed)
