module.exports = class Data1645625195067 {
  name = 'Data1645625195067'

  async up(db) {
    await db.query(`CREATE TABLE "chain_info" ("id" character varying NOT NULL, "name" text NOT NULL, "token" jsonb NOT NULL, "para_id" integer NOT NULL, "relay_chain" character varying(8) NOT NULL, CONSTRAINT "PK_1b82ce2acbc16bfc7f84bfdc8ff" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "chain_state" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE, "token_balance" numeric, "token_holders" integer, "council_members" integer, "democracy_proposals" integer, "council_proposals" integer, "chain_id" character varying, CONSTRAINT "PK_e28e46a238ada7cbbcf711b3f6c" PRIMARY KEY ("id"))`)
